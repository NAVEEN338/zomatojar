...
* Java 11 (_version tested_)
* Node v14.17.3 (_version tested_)
* yarn 1.22.10 (_version tested_)
* Eclipse
...
_Note: both frontend and backend are configured to start on path /projectname. Moreover frontend subpaths follow this pattern: /projectname/#/subpath._
...
Now you can test your app in http://localhost:3000/zomato1
...
* Start backend sever
    ...
    mvn spring-boot:run
    ```
Thanks to the provided plugin configuration you can access your React app directly on http://localhost:8080/zomato1
